...
trains.push(new Train("07", 6, map, track, map.getTrackCircuitFromName("YAG_08"), "northbound", interlocking, ats))
...
trains.push(new Train("10", 6, map, track, map.getTrackCircuitFromName("ZOO_05"), "southbound", interlocking, ats))
trains.push(new Train("11", 6, map, track, map.getTrackCircuitFromName("PAZ_20"), "southbound", interlocking, ats))
...
trains.push(new Train("15", 6, map, track, map.getTrackCircuitFromName("CPU_12"), "northbound", interlocking, ats))
trains.push(new Train("16", 6, map, track, map.getTrackCircuitFromName("ART_08"), "northbound", interlocking, ats))
