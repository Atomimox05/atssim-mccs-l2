...
var trains = []
trains.push(new Train("01", 6, map, track, map.getTrackCircuitFromName("RUI_16"), "northbound", interlocking, ats))
...
trains.push(new Train("08", 6, map, track, map.getTrackCircuitFromName("MAM_12"), "northbound", interlocking, ats))
